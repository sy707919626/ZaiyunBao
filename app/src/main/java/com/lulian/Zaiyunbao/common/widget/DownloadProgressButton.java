...
public class DownloadProgressButton extends android.support.v7.widget.AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_color, Color.parseColor("#00beff"));
            mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_second_color, Color.parseColor("#FFFFFF"));
    ...
    public void setTextS(float size){
        this.mTextSize = size;
    }
