...
public class SubleaseOrderActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        textDetailContent.setText("转租订单");
        textDetailRight.setVisibility(View.GONE);
        PagerAdapter adapter = new SubleaseOrderViewPagerAdapter(this.getSupportFragmentManager());
