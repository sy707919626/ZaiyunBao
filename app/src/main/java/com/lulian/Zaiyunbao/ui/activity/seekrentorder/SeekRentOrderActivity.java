...
public class SeekRentOrderActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        textDetailContent.setText("求租订单");
        textDetailRight.setVisibility(View.GONE);
        PagerAdapter adapter = new SeekRentOrderViewPagerAdapter(this.getSupportFragmentManager());
