...
public class DeviceManageZYFragment extends BaseLazyFragment {
...
//    }
    ...
    private void updateVideo() {
        ...
        if (index == 1) {
            msg.setText("更改为闲置状态后不可恢复，是否修改该条目？");
        } else {
            msg.setText("更改为闲置状态后不可恢复，是否修改这" + index + "个条目？");
        }
