...
public class ReceiveLeaseInfoActivity extends BaseActivity {
    ...
    private ReceivedLeaseAdapter mAdapter;
...
//        smartLayout.autoRefresh(); //触发自动刷新
        ...
        mAdapter = new ReceivedLeaseAdapter(this, mReceivedLeaseList);
        ...
        mApi.myEquipmentRentOrderItem(GlobalParams.sToken, body)
                ...
                .subscribe(new ErrorHandlerSubscriber<String>() {
                    ...
                    public void onNext(String s) {
                        ...
                        receiveSum.setText(receivedLeaseBean.getTotal() + "");
