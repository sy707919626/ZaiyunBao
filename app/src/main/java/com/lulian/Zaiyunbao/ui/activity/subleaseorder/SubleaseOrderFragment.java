...
public class SubleaseOrderFragment extends BaseLazyFragment {
    ...
    private SubleaseOrderAdapter mAdapter;
    private ArrayList<MyOrderLisetBean.RowsBean> mOrderListBean = new ArrayList<>();
    private String Status;

    public SubleaseOrderFragment(String status) {
        Status = status;
    }
...
//        OrderRecyclerView.addItemDecoration(new RecyclerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
        ...
        mAdapter = new SubleaseOrderAdapter(getContext(), mOrderListBean, mApi, false);
        OrderRecyclerView.setAdapter(mAdapter);


        mAdapter.setOnItemClickListener(new SubleaseOrderAdapter.OnItemClickListener() {

            @Override
            public void onItemClickListener(int position, ArrayList<MyOrderLisetBean.RowsBean> orderListBean) {
                Intent intent = new Intent(getContext(), SubleaseOrderDetailsActivity.class);
