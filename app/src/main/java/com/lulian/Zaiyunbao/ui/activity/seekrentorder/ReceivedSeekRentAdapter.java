...
public class ReceivedSeekRentAdapter extends RecyclerView.Adapter<ReceivedSeekRentAdapter.ReceivedLeaseHolder> {
    ...
    public ReceivedSeekRentAdapter(Context context, ArrayList<ReceivedLeaseBean.RowsBean> receivedLeaseBean) {
