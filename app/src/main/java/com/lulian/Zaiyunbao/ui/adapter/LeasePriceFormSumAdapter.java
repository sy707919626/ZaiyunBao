...
public class LeasePriceFormSumAdapter extends RecyclerView.Adapter {
    ...
    public LeasePriceFormSumAdapter(Context context, List<LeasePriceFromBean> leasePriceFromBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEAD) {
            View itemView = LayoutInflater.from(mContext).inflate(R.layout.lease_priceformsum_head, parent, false);
            return new HeadHolder(itemView);

        } else {
            View itemView = LayoutInflater.from(mContext).inflate(R.layout.lease_priceformsum_content, parent, false);
