...
public class RepairOrderActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        textDetailContent.setText("维修单列表");
        textDetailRight.setVisibility(View.GONE);


        PagerAdapter adapter = new RepairOrderViewPagerAdapter(this.getSupportFragmentManager());
        viewLeasePager.setAdapter(adapter);
        tabLeaseLayout.setupWithViewPager(viewLeasePager);
        tabLeaseLayout.setTabMode(TabLayout.MODE_FIXED);
