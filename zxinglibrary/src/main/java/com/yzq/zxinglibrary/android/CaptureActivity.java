...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private ImageView back, flashLight;
    ...
    private void initView() {
        ...
        flashLight = (ImageView) findViewById(R.id.iv_flash_light);
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.iv_back) {
            finish();
        } else if (i == R.id.iv_flash_light) {
            //切换闪光灯
            cameraManager.switchFlashLight(handler);
        } else if (i == R.id.flashLightLayout) {
            //切换闪光灯
            cameraManager.switchFlashLight(handler);
        } else if (i == R.id.albumLayout) {
            //打开相册
