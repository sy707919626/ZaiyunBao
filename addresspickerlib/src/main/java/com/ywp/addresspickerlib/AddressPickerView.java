...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private OnAddressPickerSureListeners mOnAddressPickerSureListeners;
...
//            sure(); //完整地址
    ...
    private void sures() {
        if (mSelectProvice != null &&
                ...
                mSelectDistrict != null) {
            //   回调接口
            if (mOnAddressPickerSureListeners != null) {
                mOnAddressPickerSureListeners.onSureClick(mSelectDistrict.getN(), mSelectProvice.getN(),
                        mSelectCity.getN(),
    ...
    public void setOnAddressPickerSures(OnAddressPickerSureListeners listener) {
        this.mOnAddressPickerSureListeners = listener;
    }
     ...
     * 点确定回调这个接口
     */
    public interface OnAddressPickerSureListeners {
        void onSureClick(String address, String shengfen, String city, String provinceCode, String cityCode, String districtCode);
    }
